...
<main id="main-container">
    ...
    <?php
      ...
      if(@$_REQUEST['s']=='1091vdf8ame151') {
        ...
        $sql = "SELECT user_id,username,full_name,department_id,department_name,user_active_status,DATE_FORMAT(DATE_ADD(user_last_login,INTERVAL '".$_SESSION['selisih']."' HOUR), '%d/%m/%Y on %H:%i') as user_last_login FROM tbl_user a INNER JOIN tbl_department b using (department_id) WHERE (username LIKE '%$txt_search%' OR full_name LIKE '%$txt_search%') AND client_id = '".$_SESSION['client_id']."' LIMIT $offset, $dataPerPage";
      }elseif (@$_REQUEST['s']=='1'){
        $sql = "SELECTuser_id,username,full_name,department_id,department_name,user_active_status,DATE_FORMAT(DATE_ADD(user_last_login,INTERVAL '".$_SESSION['selisih']."' HOUR), '%d/%m/%Y on %H:%i') as user_last_login FROM tbl_user a INNER JOIN tbl_department b using (department_id) WHERE client_id = '".$_SESSION['client_id']."' ORDER by full_name LIMIT $offset, $dataPerPage";
      }elseif (@$_REQUEST['s']=='2'){
        $sql = "SELECT user_id,username,full_name,department_id,department_name,user_active_status,DATE_FORMAT(DATE_ADD(user_last_login,INTERVAL '".$_SESSION['selisih']."' HOUR), '%d/%m/%Y on %H:%i') as user_last_login FROM tbl_user a INNER JOIN tbl_department b using (department_id) WHERE client_id = '".$_SESSION['client_id']."' ORDER by department_id LIMIT $offset, $dataPerPage";
      }elseif (@$_REQUEST['s']=='3'){
        $sql = "SELECT user_id,username,full_name,department_id,department_name,user_active_status,DATE_FORMAT(DATE_ADD(user_last_login,INTERVAL '".$_SESSION['selisih']."' HOUR), '%d/%m/%Y on %H:%i') as user_last_login FROM tbl_user a INNER JOIN tbl_department b using (department_id) WHERE client_id = '".$_SESSION['client_id']."' ORDER by user_active_status LIMIT $offset, $dataPerPage";      
      }else{
        $sql = "SELECT user_id,username,full_name,department_id,department_name,user_active_status,DATE_FORMAT(DATE_ADD(last_login,INTERVAL '".$_SESSION['selisih']."' HOUR), '%d/%m/%Y on %H:%i') as user_last_login FROM tbl_user a INNER JOIN tbl_department b using (department_id) WHERE a.client_id = '".$_SESSION['client_id']."' LIMIT $offset, $dataPerPage";
      }
    ...
    <?php } ?>    
        ...
        if(@$_REQUEST['s']=='1091vdf8ame151') {           
          $sql = "SELECT count(user_id) as jumData FROM tbl_user a INNER JOIN tbl_department b USING (department_id) WHERE a.client_id = '".$_SESSION['client_id']."' AND (username LIKE '%$txt_search%' OR full_name LIKE '%$txt_search%')";
        }elseif(@$_REQUEST['s']=='1') {           
          $sql = "SELECT count(user_id) as jumData FROM tbl_user a INNER JOIN tbl_department b USING (department_id) WHERE a.client_id = '".$_SESSION['client_id']."' ORDER by full_name";
        }elseif(@$_REQUEST['s']=='2') {           
          $sql = "SELECT count(user_id) as jumData FROM tbl_user a INNER JOIN tbl_department b USING (department_id) WHERE a.client_id = '".$_SESSION['client_id']."' ORDER by department_id";
        }elseif(@$_REQUEST['s']=='3') {           
          $sql = "SELECT count(user_id) as jumData FROM tbl_user a INNER JOIN tbl_department b USING (department_id) WHERE a.client_id = '".$_SESSION['client_id']."' ORDER by user_active_status";
        }else{            
          $sql = "SELECT count(user_id) as jumData FROM tbl_user a INNER JOIN tbl_department b USING (department_id) WHERE a.client_id = '".$_SESSION['client_id']."'";
        }          
