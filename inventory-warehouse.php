        ...
        <div class="content-side">
            ...
            <div class="block pull-t pull-r-l">
                <div class="block-content block-content-full block-content-sm bg-body-light">
                    <form action="inventory-warehouse.php" method="post">
...
<main id="main-container">
    ...
    <?php
      ...
      if(@$_REQUEST['s']=='1091vdf8ame151') {
        ...
        $sql = "SELECT * FROM tbl_parts_warehouse WHERE (parts_warehouse_name LIKE '%$txt_search%' OR parts_warehouse_location LIKE '%$txt_search%') AND client_id = '".$_SESSION['client_id']."' LIMIT $offset, $dataPerPage";
      }elseif (@$_REQUEST['s']=='1'){
        $sql = "SELECT * FROM tbl_parts_warehouse  WHERE client_id = '".$_SESSION['client_id']."' ORDER by parts_warehouse_name LIMIT $offset, $dataPerPage";      
      }else{
        $sql = "SELECT * FROM tbl_inventory_warehouse ORDER BY warehouse_name LIMIT $offset, $dataPerPage";
      }
    ...
    <?php } ?>    
        <div class="block table-responsive">
            <div class="block-header block-header-default">
                <h3 class="block-title">Warehouse <a data-toggle="modal" data-target="#modal-add" href="#">[add]</a> <a  href="<?php echo $file.$ext ?>">[view all]</a></h3>
                <div class="block-options">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit" href="inventory-warehouse-detail.php?act=29dvi59&ntf=29dvi59-<?php echo $row["parts_warehouse_id"]?>-94dfvj!sdf-349ffuaw">
        ...
        if(@$_REQUEST['s']=='1091vdf8ame151') {           
          $sql = "SELECT count(parts_warehouse_id) as jumData FROM tbl_parts_warehouse  WHERE client_id = '".$_SESSION['client_id']."' AND (parts_warehouse_name LIKE '%$txt_search%' OR parts_warehouse_location LIKE '%$txt_search%')";
        }elseif(@$_REQUEST['s']=='1') {           
          $sql = "SELECT count(parts_warehouse_id) as jumData FROM tbl_parts_warehouse WHERE client_id = '".$_SESSION['client_id']."' ORDER by aircraft_reg_code";
        }else{            
          $sql = "SELECT count(parts_warehouse_id) as jumData FROM tbl_parts_warehouse WHERE client_id = '".$_SESSION['client_id']."'";
        }          
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">
                      <i class="fa fa-pencil mr-5"></i> Create New Warehouse
                    </h3>
                    <div class="block-options">
