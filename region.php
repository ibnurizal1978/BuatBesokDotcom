...
<main id="main-container">
    ...
    <?php
      ...
      if(@$_REQUEST['s']=='1091vdf8ame151') {
        ...
        $sql = "SELECT  region_id, region_name, region_description, country_name FROM tbl_region a INNER JOIN tbl_country b USING (country_id) WHERE (region_name LIKE '%$txt_search%') AND a.client_id = '".$_SESSION['client_id']."' LIMIT $offset, $dataPerPage";
      }elseif (@$_REQUEST['s']=='1'){
        $sql = "SELECT region_id, region_name, region_description, country_name FROM tbl_region a INNER JOIN tbl_country b USING (country_id) WHERE a.client_id = '".$_SESSION['client_id']."' ORDER BY region_name LIMIT $offset, $dataPerPage";     
      }else{
        $sql = "SELECT region_id, region_name, region_description, country_name FROM tbl_region a INNER JOIN tbl_country b USING (country_id) WHERE a.client_id = '".$_SESSION['client_id']."' ORDER BY region_name LIMIT $offset, $dataPerPage";
      }
    ...
    <?php } ?>    
        <div class="block table-responsive">
            <div class="block-header block-header-default">
                <h3 class="block-title">Region <a data-toggle="modal" data-target="#modal-add" href="#">[add]</a> <a  href="<?php echo $file.$ext ?>">[view all]</a></h3>
                <div class="block-options">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a type="button" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#modal-edit<?php echo $row['region_id'] ?>" href="#">edit
                                    </a>                                                                       
                                </div>
                            </td>
                            <!-- Compose Modal -->
                            <div class="modal fade" id="modal-edit<?php echo $row['region_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-large" aria-hidden="true"> 
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="block block-themed block-transparent mb-0">
                                            <div class="block-header">
                                                <h3 class="block-title">
                                                  <i class="fa fa-pencil mr-5"></i> Edit Region <?php echo $row['region_name'] ?>
                                                </h3>
                                                <div class="block-options">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="region_name" value="<?php echo $row['region_name'] ?>" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="bmd-label-floating">Description</label>
                                                                <input type="text" class="form-control" name="region_description" value="<?php echo $row['region_description'] ?>" autocomplete="off" />
                                                            </div>
                                                        </div>                                       
                                                        <div class="col-md-4">                            
                                                            <div class="form-group">
        ...
        if(@$_REQUEST['s']=='1091vdf8ame151') {           
          $sql = "SELECT count(region_id) as jumData FROM tbl_region a INNER JOIN tbl_country b USING (country_id) WHERE a.client_id = '".$_SESSION['client_id']."' AND (region_name LIKE '%$txt_search%')";
        }elseif(@$_REQUEST['s']=='1') {           
          $sql = "SELECT count(region_id) as jumData FROM  tbl_region a INNER JOIN tbl_country b USING (country_id) WHERE a.client_id = '".$_SESSION['client_id']."'";
        }else{            
          $sql = "SELECT count(region_id) as jumData FROM  tbl_region a INNER JOIN tbl_country b USING (country_id) WHERE a.client_id = '".$_SESSION['client_id']."'";
        }          
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">
                      <i class="fa fa-pencil mr-5"></i> Create New Region
                    </h3>
                    <div class="block-options">
                      <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                          <i class="si si-close"></i>
                    ...
                    <form action="<?php echo $file.'-add'.$ext ?>" method="POST">
                       <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Region Name</label>
                                    <input type="text" class="form-control" name="region_name" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Description</label>
                                    <input type="text" class="form-control" name="region_description" autocomplete="off" />
                                </div>
                            </div>                                       
                            <div class="col-md-4">                            
                                <div class="form-group">
