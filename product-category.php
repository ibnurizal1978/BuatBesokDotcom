...
<main id="main-container">
    ...
    <?php
      ...
      if(@$_REQUEST['s']=='1091vdf8ame151') {
        ...
        $sql = "SELECT  * FROM tbl_product_category WHERE (product_category_name LIKE '%$txt_search%') AND client_id = '".$_SESSION['client_id']."' LIMIT $offset, $dataPerPage";
      }elseif (@$_REQUEST['s']=='1'){
        $sql = "SELECT * FROM tbl_product_category WHERE client_id = '".$_SESSION['client_id']."' ORDER BY product_category_name LIMIT $offset, $dataPerPage";     
      }else{
        $sql = "SELECT * FROM tbl_product_category WHERE client_id = '".$_SESSION['client_id']."' ORDER BY product_category_name LIMIT $offset, $dataPerPage";
      }
    ...
    <?php } ?>    
        <div class="block table-responsive">
            <div class="block-header block-header-default">
                <h3 class="block-title">Product Category <a data-toggle="modal" data-target="#modal-add" href="#">[add]</a> <a  href="<?php echo $file.$ext ?>">[view all]</a></h3>
                <div class="block-options">
                    ...
                    <tbody>
                        ...
                        <tr>                            
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a type="button" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#modal-edit<?php echo $row['product_category_id'] ?>" href="#">edit
                                    </a>                                                                       
                                </div>
                            </td>
                            <!-- Compose Modal -->
                            <div class="modal fade" id="modal-edit<?php echo $row['product_category_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-large" aria-hidden="true"> 
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="block block-themed block-transparent mb-0">
                                            <div class="block-header">
                                                <h3 class="block-title">
                                                  <i class="fa fa-pencil mr-5"></i> Edit Category <?php echo $row['product_category_name'] ?>
                                                </h3>
                                                <div class="block-options">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="product_category_name" value="<?php echo $row['product_category_name'] ?>" autocomplete="off" />
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        if(@$_REQUEST['s']=='1091vdf8ame151') {           
          $sql = "SELECT count(product_category_id) as jumData FROM tbl_product_category WHERE client_id = '".$_SESSION['client_id']."' AND (product_category_name LIKE '%$txt_search%')";
        }elseif(@$_REQUEST['s']=='1') {           
          $sql = "SELECT count(product_category_id) as jumData FROM  tbl_product_category WHERE client_id = '".$_SESSION['client_id']."'";
        }else{            
          $sql = "SELECT count(product_category_id) as jumData FROM  tbl_product_category WHERE client_id = '".$_SESSION['client_id']."'";
        }          
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header">
                    <h3 class="block-title">
                      <i class="fa fa-pencil mr-5"></i> Create New Category
                    </h3>
                    <div class="block-options">
                      <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                          <i class="si si-close"></i>
                    ...
                    <form action="<?php echo $file.'-add'.$ext ?>" method="POST">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Category Name</label>
                                    <input type="text" class="form-control" name="product_category_name" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <input type="submit" class="btn btn-success mr-5 mb-5" value="Save" /> <a class="btn btn-info mr-5 mb-5 text-white" data-dismiss="modal"><i class="si si-close"></i> Close</a>
