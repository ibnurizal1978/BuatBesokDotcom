  ...
  <div class="content">
    ...
    <div class="block table-responsive">
      <div class="block-header block-header-default">
        <h3 class="block-title">Create New Warehouse Data</h3>
      </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="warehouse_name" autocomplete="off" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label class="bmd-label-floating">Warehouse Location</label>
                  <input type="text" class="form-control" name="warehouse_location" autocomplete="off" />
                </div>
              </div>                                                                           
            </div>            
...
$(document).ready(function(){
  ...
  $('#form_simpan').on('submit', function(event){
    ...
    $.ajax({  
      url:"inventory-warehouse-add.php",  
      method:"POST",  
