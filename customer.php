...
<main id="main-container">
    ...
    <!-- Small Table -->
      ...
      if(@$_REQUEST['s']=='1091vdf8ame151') {
        ...
        $sql = "SELECT customer_id, customer_account_id, customer_name, customer_address, customer_email_address, customer_phone_number, customer_active_status, ledger_master_amount, db_evoucher.tbl_partner.partner_name ,date_format(created_date, '%d/%m/%Y') as created_date FROM db_customer.tbl_customer INNER JOIN db_customer.tbl_ledger_master USING (customer_account_id) INNER JOIN db_evoucher.tbl_partner ON db_customer.tbl_customer.partner_key = db_evoucher.tbl_partner.partner_key LIMIT $offset, $dataPerPage";
      }
      ...
      ?>    
            ...
            <div class="block-content">
                <table class="table table-sm table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $row['customer_account_id'] ?></td>
                            ...
                            <td><?php echo 'Rp. '.number_format($row['ledger_master_amount'],0,",",".") ?>
                            <td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="customer-detail.php?act=29dvi59&ntf=29dvi59-<?php echo $row["customer_account_id"]?>-94dfvj!sdf-349ffuaw">edit</a>&nbsp;|&nbsp;<a href="customer-ledger.php?act=29dvi59&ntf=29dvi59-<?php echo $row["customer_account_id"]?>-94dfvj!sdf-349ffuaw">balance</a>
                                </div>
                            </td>
                        </tr>
        ...
        if(@$_REQUEST['s']=='1091vdf8ame151') {           
          ...
          $sql = "SELECT count(customer_id) as jumData FROM db_customer.tbl_customer INNER JOIN db_customer.tbl_ledger_master USING (customer_account_id) INNER JOIN db_evoucher.tbl_partner ON db_customer.tbl_customer.partner_key = db_evoucher.tbl_partner.partner_key";
        }          
