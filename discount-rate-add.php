...
if($discount_rate_name == "" || $discount_rate_amount == "") {
  echo "<script>";
...
//apakah ada duplikat?
$sql  = "SELECT discount_rate_name FROM tbl_discount_rate WHERE discount_rate_name = '".$discount_rate_name."' AND client_id = '".$_SESSION['client_id']."' LIMIT 1";
...
$sql2   = "INSERT INTO tbl_discount_rate (discount_rate_name,discount_rate_amount, discount_rate_start_date, discount_rate_end_date, created_date, client_id, user_id) VALUES ('".$discount_rate_name."', '".$discount_rate_amount."', '".$discount_rate_start_date_f."', '".$discount_rate_end_date_f."', UTC_TIMESTAMP(), '".$_SESSION['client_id']."', '".$_SESSION['user_id']."')";
mysqli_query($conn,$sql2);

//insert ke table log user
$sql_log   = "INSERT INTO tbl_user_log (user_log_action,user_log_module,user_id,user_log_date,user_log_notes,client_id) VALUES ('ADD','DISCOUNT-RATE','".$_SESSION['user_id']."',UTC_TIMESTAMP(),'$discount_rate_name','".$_SESSION['client_id']."')";
